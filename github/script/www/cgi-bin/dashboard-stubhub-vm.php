...
if ( $var1 == 'SRWPINT' ) {
  	 echo "<h1 align=center font size=1><img src=/icons/Internal.png></center></h1>";
	$hostname='10.80.66.35';
	}
	else {
	echo "<h1 align=center font size=1><img src=/icons/External.png></center></h1>";
...
#        } else {
if ( $var1 == 'SRWPINT' ) {
	 $getvm = getvmname($name);
	 if ( $getvm == 'VM') {
         echo "<li>$img   <a href=dashboard-stubhub-info.pl?myhosts=$name>$name </a> <a href=http://$name/web-console target=_blank> <img src=/icons/jb-wc.gif></a></li>";
         } else {
          }
	}
	else {
	 ...
	 $getvm = getvmname($name);
         if ( $getvm == 'VM') {
         echo "<li>$img  <a href=dashboard-stubhub-info.pl?myhosts=$hname>$hname </a> <a href=http://$hname/web-console target=_blank> <img src=/icons/jb-wc.gif></a></li>";
         } else {
         }
	}
#        }
...
function getvmname($name) {
 
$cmd = "ssh $name -o StrictHostKeyChecking=no -o ConnectTimeout=1 /sbin/lspci | grep SVGA" ;
