...
@F=File.new("/nas/home/quwang/script/task3_ruby/result/mail","a+")

def command1(str)
		
		@F.puts "------------The level information of ROLES #{str} ------------"	
...
#write the result to file;      
		...
		file.puts(command)
		  ...
		  if $var1=="sws06"
			  @F.puts "------------The level information of ROLES sws ------------"
